...
(function () {
  ...
  var T = {
    ...
    'ins-feat-title':  { zh: '电动工具设计的人机工程学：如何让专业工具更易用', en: 'Ergonomics in Power Tool Design: Making Professional Tools Easier to Use' },
    ...
    'ins-1-title': { zh: 'CMF趋势报告：2026年电动工具色彩与材料走向', en: 'CMF Trend Report: 2026 Power Tool Color & Material Directions' },
    ...
    'ins-2-title': { zh: '从贴牌到品牌：电动工具企业的设计转型路径', en: 'From OEM to Brand: Design Transformation Path for Power Tool Companies' },
    ...
    'ins-3-title': { zh: '清洁家电出海：从中国工厂到全球品牌的跨越', en: 'Cleaning Appliances Going Global: From Chinese Factory to Global Brand' },
    ...
    'ins-4-title': { zh: '手板验证为什么重要：避免量产翻车的第一道防线', en: 'Why Prototyping Matters: The First Line of Defense Against Mass Production Failures' },
    ...
    'ins-5-title': { zh: '用户访谈的陷阱：设计师常犯的5个错误', en: 'User Interview Pitfalls: 5 Common Mistakes Designers Make' },
    ...
    'ins-6-title': { zh: '为什么极简主义在电动工具设计中越来越流行', en: 'Why Minimalism Is Becoming Increasingly Popular in Power Tool Design' },
